export const config = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: "wx3ad6e1fd494d75fb",

  // 公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: "d5a49e942ce0ca81509337943a6e516d",
  ...
  USERS: [oDPZX685IvLmZdkQLmpT0nKQh3uc
    {
      ...
      id: "oDPZX685IvLmZdkQLmpT0nKQh3uc",
      // 你想对他发送的模板消息的模板ID
      useTemplateId: "1	pstRwek5Da249h_QRlNzyXsSHi5b4iai0cbJz_JZT5c",
      // 所在省份
      province: "吉林",
      // 所在城市
      city: "长春",
